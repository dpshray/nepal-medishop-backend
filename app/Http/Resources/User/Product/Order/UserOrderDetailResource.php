        ...
        return [
            ...
            'ordered_items' => $this->orderItems->map(function ($item) {
                $data = [
                    ...
                    'variant_form_type' => $item->productVariant?->form_type,
                    'variant_package_type' => $item->productVariant?->package_type,
                    'variant_package_size' => $item->productVariant?->package_size,
                    'variant_strength' => $item->productVariant?->strength,
