...
class ProductUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'variations.*.variant_unit' => 'required|string',
            ...
            // 'variations.*.image'   => 'sometimes|image|mimes:jpeg,jpg,png,webp|max:5000|exclude',
        ...
        if ($product_id == null) {
            $rules = array_merge($rules, [
                'featured_image' => 'sometimes|image|mimes:jpeg,jpg,png,webp|max:5000|exclude',
                'gallery_images'   => 'sometimes|array|max:10|exclude',
