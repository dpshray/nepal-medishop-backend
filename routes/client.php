...
use App\Http\Controllers\Api\V1\Client\NCM\ClientNCMController;
...
Route::prefix('ncm')->group(function () {
    Route::controller(ClientNCMController::class)->group(function () {
        Route::get('get-ncmbranch', 'getBranches');
        Route::post('calculate-delivery-charge', 'calculateRate');
    });
});
